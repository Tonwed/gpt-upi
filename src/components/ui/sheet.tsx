  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-0 z-50 flex h-dvh w-full max-w-md flex-col gap-4 bg-background p-5 text-foreground shadow-2xl ring-1 ring-foreground/10 duration-150 outline-none data-open:animate-in data-closed:animate-out sm:max-w-lg",
          side === "right"
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="sheet-footer" className={cn("mt-auto flex flex-col-reverse gap-2 border-t pt-4 sm:flex-row sm:justify-end", className)} {...props} />
}

function SheetTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return <DialogPrimitive.Title data-slot="sheet-title" className={cn("font-heading text-lg leading-none font-semibold", className)} {...props} />
}
